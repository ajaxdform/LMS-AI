              ...
              {isAuthenticated && (
                <>
                  ...
                  {isAdmin && (
                    <Link
                      to="/admin"
                      className="border-transparent text-purple-600 hover:border-purple-300 hover:text-purple-800 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"
                    >
                      Admin Panel
                    </Link>
                  )}
